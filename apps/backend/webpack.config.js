...
const RUNTIME_EXTERNALS =
  /^(@sentry|@opentelemetry)\/|^google-auth-library(\/|$)|^(require-in-the-middle|import-in-the-middle)$|^@apollo\/|^@nestjs\/(apollo|graphql)(\/|$)|^@as-integrations\/fastify(\/|$)|^ts-morph(\/|$)|^graphql(\/|$)/;
